...
useEffect(() => {
  ...
  return (
    <>
      ...
      {isInvoice && (
        <>
          {invoiceOrder.status === "cancelled" ? (
            <div className="bg-gray-300 py-10 print:bg-white relative">
                ...
                {(invoiceOrder.status === 'cancelled' || invoiceOrder.paymentStatus === 'refunded') && (
                  <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-50">
                    ...
                    <div className="absolute top-0 left-0 transform -rotate-12">
                      <span className="text-4xl font-black text-red-600 opacity-20">CANCELLED</span>
                    </div>
                                ...
                                <div className="inline-block border border-gray-200 p-1 rounded">
                                  <div className="w-[100px] h-[100px] bg-gray-100 flex items-center justify-center text-[6px] text-gray-400">
                                    <div className="text-center">
                                      <QRCode
                                          value={`${window.location.origin}/user/dashboard/invoice/${data.id}`}
                                           size={90}
                                      />
                                    </div>
                                  </div>
                          ...
                          <tbody>
                            {invoiceOrder.items?.map((item, index) => (
                              <tr key={index} className="hover:bg-gray-50">
                                ...
                                <td className="border p-2 text-xs">{item.name }|| {item.category}</td>
            ...
            <div className="bg-gray-300 py-10 print:bg-white ">

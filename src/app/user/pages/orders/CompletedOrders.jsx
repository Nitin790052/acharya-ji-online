...
const completedOrders = [
  ...
  },
  {
    ...
    date: '22 July 2024',
    time: '1:30 PM',
    serviceName: 'Tarot Reading Session',
    ...
    type: 'online',
     items: [
      ...
      { name: 'Lab Certificate', quantity: 1, price: 200 },
  ...
  },
  {
    ...
    date: '26 July 2024',
    time: '2:00 PM',
    serviceName: 'Shree Yantra (Copper)',
    ...
    type: 'offline',
    items: [
      { name: 'Shree Yantra Copper', quantity: 1, price: 1499 }
    ]
  },
  {
    id: 'ORD032',
  ...
  },
  {
    ...
    type: 'offline',
    items: [
      { name: 'Emerald Stone', quantity: 1, price: 3000 },
      { name: 'Certification', quantity: 1, price: 200 }
    ]
  },
  {
    id: 'ORD034',
  ...
  },
  {
    ...
    type: 'offline',
    items: [
      { name: 'Sphatik Mala', quantity: 1, price: 1200 }
    ]
  }
];
 ...
 const handleDownloadInvoice = (orderId,orderData) => {
  ...
  const handleRateService = (serviceName) => {
    toast.info(`Rate ${serviceName} - Opening review form...`);
  };
  ...
  const statsCards = [
    ...
    { 
      label: 'Completed',
      value: completedOrders.filter(o => o.status === 'completed').length,
      bgColor: 'bg-green-50',
      icon: <Award className="text-green-600" size={20} />
    },
    { 
      label: 'Total Spent',
      value: formatCurrency(completedOrders.reduce((sum, o) => sum + o.amount, 0)),
      bgColor: 'bg-amber-50',
      icon: <ShoppingBag className="text-amber-600" size={20} />
    },
    { 
      label: 'All Paid',
      value: completedOrders.filter(o => o.paymentStatus === 'paid').length,
      bgColor: 'bg-green-50',
          ...
          <div className="text-left sm:text-left flex items-end gap-2">
            <div>
              <h1 className="text-lg sm:text-xl md:text-2xl lg:text-[25px] font-semibold text-amber-900 uppercase leading-tight flex items-center gap-2">
                <Award className="w-[23px] h-[23px] text-amber-600" />
                Completed Orders
              </h1>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          {statsCards.map((stat, index) => (
            <div 
              ...
              onClick={() => {
                if (stat.label === 'Completed') setPaymentFilter('completed');
                else if (stat.label === 'All Paid') setPaymentFilter('paid');
                ...
                {filteredOrders.length === 0 ? (
                  <tr>
                    <td colSpan="7" className="px-4 py-8 text-center text-gray-500">
                      ...
                      <p className="text-sm font-medium text-gray-600">No completed orders found</p>
                    ...
                    >
                      ...
                      <td className="px-4 py-3">
                        <div className="flex items-center gap-2" onClick={(e) => e.stopPropagation()}>
                          ...
                          <button
                            onClick={() => handleRateService(order.serviceName)}
                            className="p-1 text-amber-600 hover:bg-amber-50 rounded"
                            title="Rate Service"
                          >
        ...
        <div className="bg-gradient-to-r from-amber-100/50 via-amber-200/30 to-amber-300/40 rounded-lg border border-amber-200 p-3">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
            <div className="flex items-center gap-2">
              ...
              <div>
                <h4 className="text-xs font-semibold text-gray-800">Completed Orders</h4>
            ...
            <button 
              ...
              onClick={() => toast.info('View order history...')}
            >
              View History
            </button>
          </div>
            ...
            <div ref={printRef} className="p-4 space-y-4 print:p-8">
              ...
              <div className="grid grid-cols-2 gap-2 pt-2 print:hidden">
                <button
                  ...
                  // onClick={()=>navigate(`/user/dashboard/invoice/${selectedOrder.id}`,)}
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                <button
                  onClick={() => handleRateService(selectedOrder.serviceName)}
                  className="bg-amber-500 text-white py-2 rounded-lg hover:bg-amber-600 flex items-center justify-center gap-2"
                >
                  <Star className="w-4 h-4" />
                  Rate Service

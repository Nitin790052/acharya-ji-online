    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="space-y-4 px-3">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
          <div>
            <h1 className="text-[26px] font-bold text-gray-800">Wallet & Earnings</h1>
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-3">
            ...
            <div className="flex items-center gap-2">
              <div className="flex-1">
                {canWithdraw ? (
                  <button className="w-full px-2.5 py-1.5 text-sm bg-gradient-to-r from-orange-500 to-orange-600 text-white rounded hover:from-orange-600 hover:to-orange-700 flex items-center justify-center gap-2">
          ...
          <div className="p-3">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-4">
              ...
              <div className="bg-gray-50 rounded-lg p-3">
                ...
                <div className="text-xl font-bold text-gray-800 mb-1">{activeData.bookings}</div>
          ...
          <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
            ...
            <div className="p-3 border-t border-gray-200">
              <div className="flex gap-2">
                ...
                <button className="flex-1 px-2.5 py-1.5 text-sm bg-gradient-to-r from-orange-500 to-orange-600 text-white rounded hover:from-orange-600 hover:to-orange-700 flex items-center justify-center gap-2">
        ...
        <div className="bg-gray-50 rounded-lg border border-gray-200 p-3">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
            ...
            <div className="flex gap-2">
              ...
              <button className="px-3 py-1.5 text-sm bg-gradient-to-r from-orange-500 to-orange-600 text-white rounded-lg hover:from-orange-600 hover:to-orange-700">
                Call Now
              </button>
            </div>
          </div>

    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="space-y-4 px-3">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
          <div>
            <h1 className="text-[26px] font-bold text-gray-800">Profile & KYC</h1>
            <p className="text-sm text-gray-600 mt-1">Complete your profile for verification and payouts</p>
          </div>
